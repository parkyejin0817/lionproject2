...
-- 14. Settlements (정산)
-- =====================================================
-- 각 멘토(5명) × 2개월(2024-12 COMPLETED, 2025-01 PENDING)
-- 플랫폼 수수료: 10%
INSERT INTO settlements (mentor_id, settlement_period, total_amount, platform_fee, settlement_amount, refund_amount, final_settlement_amount, status, settled_at, created_at, updated_at) VALUES
-- 멘토 1 (tutorial 1, 2, 3)
(1, '2024-12', 850000, 85000, 765000, 0, 765000, 'COMPLETED', '2025-01-05 10:00:00', '2025-01-01 00:00:00', '2025-01-05 10:00:00'),
(1, '2025-01', 320000, 32000, 288000, 0, 288000, 'PENDING', NULL, '2025-02-01 00:00:00', '2025-02-01 00:00:00'),
-- 멘토 2 (tutorial 4, 5, 6)
(2, '2024-12', 980000, 98000, 882000, 0, 882000, 'COMPLETED', '2025-01-05 10:30:00', '2025-01-01 00:00:00', '2025-01-05 10:30:00'),
(2, '2025-01', 420000, 42000, 378000, 0, 378000, 'PENDING', NULL, '2025-02-01 00:00:00', '2025-02-01 00:00:00'),
-- 멘토 3 (tutorial 7, 8, 9)
(3, '2024-12', 480000, 48000, 432000, 0, 432000, 'COMPLETED', '2025-01-05 11:00:00', '2025-01-01 00:00:00', '2025-01-05 11:00:00'),
(3, '2025-01', 215000, 21500, 193500, 0, 193500, 'PENDING', NULL, '2025-02-01 00:00:00', '2025-02-01 00:00:00'),
-- 멘토 4 (tutorial 10, 11, 12)
(4, '2024-12', 320000, 32000, 288000, 0, 288000, 'COMPLETED', '2025-01-05 11:30:00', '2025-01-01 00:00:00', '2025-01-05 11:30:00'),
(4, '2025-01', 180000, 18000, 162000, 0, 162000, 'PENDING', NULL, '2025-02-01 00:00:00', '2025-02-01 00:00:00'),
-- 멘토 5 (tutorial 13, 14, 15)
(5, '2024-12', 270000, 27000, 243000, 0, 243000, 'COMPLETED', '2025-01-05 12:00:00', '2025-01-01 00:00:00', '2025-01-05 12:00:00'),
(5, '2025-01', 160000, 16000, 144000, 0, 144000, 'PENDING', NULL, '2025-02-01 00:00:00', '2025-02-01 00:00:00');

-- =====================================================
-- 15. Settlement Details (정산 상세)
-- =====================================================
-- 기존 payments 데이터와 연결 (플랫폼 수수료 10%)
INSERT INTO settlement_details (settlement_id, payment_id, payment_amount, platform_fee, settlement_amount, created_at, updated_at) VALUES
-- 멘토 1: 2024-12월 정산 (settlement_id=1)
(1, 1, 100000, 10000, 90000, '2025-01-01 00:00:00', '2025-01-01 00:00:00'),   -- payment 1: tutorial 1, 100000원
(1, 2, 50000, 5000, 45000, '2025-01-01 00:00:00', '2025-01-01 00:00:00'),     -- payment 2: tutorial 1, 50000원
(1, 3, 150000, 15000, 135000, '2025-01-01 00:00:00', '2025-01-01 00:00:00'),  -- payment 3: tutorial 1, 150000원
(1, 4, 60000, 6000, 54000, '2025-01-01 00:00:00', '2025-01-01 00:00:00'),     -- payment 4: tutorial 2, 60000원
(1, 20, 120000, 12000, 108000, '2025-01-01 00:00:00', '2025-01-01 00:00:00'), -- payment 20: tutorial 3, 120000원
(1, 21, 70000, 7000, 63000, '2025-01-01 00:00:00', '2025-01-01 00:00:00'),    -- payment 21: tutorial 3, 70000원
-- 멘토 1: 2025-01월 정산 (settlement_id=2)
(2, 28, 50000, 5000, 45000, '2025-02-01 00:00:00', '2025-02-01 00:00:00'),    -- payment 28: tutorial 1
(2, 29, 100000, 10000, 90000, '2025-02-01 00:00:00', '2025-02-01 00:00:00'),  -- payment 29: tutorial 1
-- 멘토 2: 2024-12월 정산 (settlement_id=3)
(3, 6, 70000, 7000, 63000, '2025-01-01 00:00:00', '2025-01-01 00:00:00'),     -- payment 6: tutorial 4
(3, 7, 70000, 7000, 63000, '2025-01-01 00:00:00', '2025-01-01 00:00:00'),     -- payment 7: tutorial 4
(3, 8, 140000, 14000, 126000, '2025-01-01 00:00:00', '2025-01-01 00:00:00'),  -- payment 8: tutorial 4
(3, 10, 40000, 4000, 36000, '2025-01-01 00:00:00', '2025-01-01 00:00:00'),    -- payment 10: tutorial 5
-- 멘토 3: 2024-12월 정산 (settlement_id=5)
(5, 12, 55000, 5500, 49500, '2025-01-01 00:00:00', '2025-01-01 00:00:00'),    -- payment 12: tutorial 7
(5, 13, 110000, 11000, 99000, '2025-01-01 00:00:00', '2025-01-01 00:00:00'),  -- payment 13: tutorial 7
-- 멘토 4: 2024-12월 정산 (settlement_id=7)
(7, 16, 70000, 7000, 63000, '2025-01-01 00:00:00', '2025-01-01 00:00:00'),    -- payment 16: tutorial 10
(7, 17, 55000, 5500, 49500, '2025-01-01 00:00:00', '2025-01-01 00:00:00');    -- payment 17: tutorial 11

-- =====================================================
-- 16. Settlement Adjustments (정산 조정)
-- =====================================================
-- 환불, 수동조정, 페널티 등 정산 조정 내역
INSERT INTO settlement_adjustments (mentor_id, target_period, amount, applied_amount, type, status, occurred_at, applied_at, created_at, updated_at) VALUES
-- REFUND (환불): 3건 (APPLIED 2, PENDING 1)
(1, '2025-01', 50000, 50000, 'REFUND', 'APPLIED', '2025-01-10 14:30:00', '2025-01-15 10:00:00', '2025-01-10 14:30:00', '2025-01-15 10:00:00'),
(2, '2025-01', 70000, 70000, 'REFUND', 'APPLIED', '2025-01-12 09:15:00', '2025-01-17 10:00:00', '2025-01-12 09:15:00', '2025-01-17 10:00:00'),
(3, '2025-01', 55000, 0, 'REFUND', 'PENDING', '2025-01-18 16:00:00', NULL, '2025-01-18 16:00:00', '2025-01-18 16:00:00'),
-- MANUAL (수동조정): 1건 (APPLIED)
(4, '2025-01', 30000, 30000, 'MANUAL', 'APPLIED', '2025-01-14 11:00:00', '2025-01-16 10:00:00', '2025-01-14 11:00:00', '2025-01-16 10:00:00'),
-- PENALTY (페널티): 1건 (PENDING)
(5, '2025-01', 20000, 0, 'PENALTY', 'PENDING', '2025-01-19 13:45:00', NULL, '2025-01-19 13:45:00', '2025-01-19 13:45:00'),
-- PARTIALLY_APPLIED: 1건
(1, '2025-02', 80000, 45000, 'REFUND', 'PARTIALLY_APPLIED', '2025-01-20 10:30:00', NULL, '2025-01-20 10:30:00', '2025-01-20 10:30:00');
